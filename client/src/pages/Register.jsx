...
function Register() {
  ...
  return (
    <div className="flex justify-center min-h-screen  bg-gradient-to-t from-blue-100 to-blue-150 ">
      <div className="flex flex-col justify-center my-auto w-full shadow-indigo-300 border-2 border-indigo-200 max-w-md p-6 bg-white rounded-lg shadow-xl space-y-4">
        <Typography
